...
- [JetBrains/xdebug-extension](https://github.com/JetBrains/xdebug-extension) ([v1.0.2](https://github.com/JetBrains/xdebug-extension/releases/tag/v1.0.2), 6 days ago) - A modern, dependency-free, cross-browser extension for Xdebug.
